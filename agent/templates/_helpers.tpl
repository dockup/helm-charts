...
{{- printf "{\"auths\": {\"gcr.io\": {\"auth\": \"%s\"}}}" (printf "_json_key:%s" (printf "{\"type\": \"service_account\", \"project_id\": \"%s\", \"private_key_id\": \"%s\", \"private_key\": \"%s\", \"client_email\": \"%s\", \"client_id\": \"%s\", \"auth_url\": \"%s\", \"token_uri\": \"%s\", \"auth_provider_x509_cert_url\": \"%s\", \"client_x509_cert_url\": \"%s\"}" .Values.secrets.pullServiceAccountKey.projectId .Values.secrets.pullServiceAccountKey.privateKeyId (.Values.secrets.pullServiceAccountKey.privateKey | replace "\n" "\\n") .Values.secrets.pullServiceAccountKey.clientEmail .Values.secrets.pullServiceAccountKey.clientId .Values.secrets.pullServiceAccountKey.authUri .Values.secrets.pullServiceAccountKey.tokenUri .Values.secrets.pullServiceAccountKey.authProviderX509CertUrl .Values.secrets.pullServiceAccountKey.clientX509CertUrl | b64enc) | b64enc) | b64enc}}
{{- end }}
